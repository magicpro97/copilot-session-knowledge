...
Uses a **unified hook runner** architecture — one `hook_runner.py` dispatcher
per event instead of 11 separate scripts. This reduces process overhead from
~11 Python processes per tool call to 1.
...
**Key improvements over legacy standalone hooks:**
