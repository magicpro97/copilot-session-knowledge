...
def _load_bsi_module():
    spec = _ilu.spec_from_file_location("build_session_index_module", Path(__file__).parent / "build-session-index.py")
...
def _load_watch_module():
    spec = _ilu2.spec_from_file_location("watch_sessions_module", Path(__file__).parent / "watch-sessions.py")
...
def _load_extract_knowledge_module():
    spec = _ilu3.spec_from_file_location("extract_knowledge_module", Path(__file__).parent / "extract-knowledge.py")
