...
def test_suite():
    ...
    vendor_path = Path(__file__).parent.parent / "browse" / "static" / "vendor" / "html-to-image.min.js"
    test("html-to-image.min.js removed", not vendor_path.exists())

    # Test 4: VENDOR.md no longer references html-to-image
    vendor_md_path = Path(__file__).parent.parent / "browse" / "static" / "vendor" / "VENDOR.md"
