...
describe("checkHostCompatibility", () => {
  ...
  it("is incompatible for http://127.0.0.2 (non-trivial 127.x.x.x) from HTTPS", () => {
  ...
  it("is incompatible for http://0.0.0.0 from an HTTPS control plane", () => {
  ...
  it("is incompatible for http://[::1] from an HTTPS control plane", () => {
  ...
  it("is compatible for a non-loopback HTTP host (rule targets loopback only)", () => {
    // http://remote.example.com is mixed-content too, but the rule is scoped to loopback.
...
describe("isOperatorHostEnabled", () => {
  ...
  it("returns false for an HTTP loopback host when control plane is HTTPS", () => {
    vi.stubGlobal("location", {
      ...window.location,
      origin: HTTPS_ORIGIN,
      protocol: "https:",
  ...
  it("returns false for http://127.0.0.1 when control plane is HTTPS", () => {
    vi.stubGlobal("location", {
      ...window.location,
      origin: HTTPS_ORIGIN,
      protocol: "https:",
  ...
  it("returns false for http://0.0.0.0 when control plane is HTTPS", () => {
    vi.stubGlobal("location", {
      ...window.location,
      origin: HTTPS_ORIGIN,
      protocol: "https:",
